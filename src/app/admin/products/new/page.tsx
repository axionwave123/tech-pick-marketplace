  ...
  return (
    <div>
      ...
      <p className="mt-2 text-sm text-surface-400">
        Full editor fields: name, brand, category, images, description, specifications, tags, SEO, slug, status.
        Wire form actions to Supabase mutations + Storage for images.
      </p>
      <div className="mt-6 grid gap-4 rounded-xl border border-surface-800 bg-surface-900 p-6">
        ...
        <label className="block text-sm text-surface-300">
          Slug
          <input className="mt-1 w-full rounded-lg border border-surface-700 bg-surface-950 px-3 py-2 text-white" placeholder="samsung-galaxy-a26-8gb-256gb" />
        </label>
        <label className="block text-sm text-surface-300">
          Status
        ...
        <div className="flex gap-3">
          ...
          <Link href="/admin/research" className="rounded-lg border border-surface-600 px-4 py-2 text-sm text-surface-200">
            AI Research
          </Link>
        </div>
      </div>
