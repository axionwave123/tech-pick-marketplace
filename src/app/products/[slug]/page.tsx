    ...
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
                        ...
                        {dealHref && (
                          <div className="mt-3">
                            <a
                              ...
                              className={
                                isBest
                                  ? 'inline-flex items-center rounded-lg bg-emerald-600 px-3.5 py-2 text-xs font-bold text-white shadow-sm transition hover:bg-emerald-500'
      ...
      <div className="mt-12 space-y-10">
        {product.what_stands_out && (
          <section>
            <h2 className="text-xl font-bold text-white light:text-surface-900">What makes it stand out</h2>
        ...
        <section className="grid gap-6 sm:grid-cols-2">
          {product.strengths && product.strengths.length > 0 && (
            <div className="rounded-2xl border border-emerald-800/50 bg-emerald-950/40 p-5 light:border-emerald-100 light:bg-emerald-50/50">
          ...
          {product.things_to_consider && product.things_to_consider.length > 0 && (
            <div className="rounded-2xl border border-amber-800/50 bg-amber-950/40 p-5 light:border-amber-100 light:bg-amber-50/50">
        ...
        {specs.length > 0 && (
          <section>
            ...
            <dl className="mt-4 divide-y divide-surface-800 rounded-2xl border border-surface-700 light:divide-surface-100 light:border-surface-200">
              {specs.map((s) => (
        ...
        {editorial && editorial.status === 'published' && (
          <section className="rounded-2xl border border-surface-700 bg-surface-900 p-6 light:border-surface-200 light:bg-white">
            ...
            {editorial.verdict && (
              <div className="mt-4 rounded-xl bg-surface-800 p-4 light:bg-surface-50">
